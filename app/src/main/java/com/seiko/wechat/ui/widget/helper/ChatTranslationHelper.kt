...
class ChatTranslationHelper(private val parentLayout: ConstraintLayout) {
    ...
    private fun createMoreLayoutConstraint() {
        moreConstraintSet.clear(R.id.wechat_view_input)
        moreConstraintSet.clear(R.id.wechat_view_more)

        moreConstraintSet.connect(R.id.wechat_view_input, ConstraintSet.TOP, R.id.wechat_list, ConstraintSet.BOTTOM)
        moreConstraintSet.connect(R.id.wechat_view_input, ConstraintSet.BOTTOM, R.id.wechat_view_more, ConstraintSet.TOP)
        moreConstraintSet.centerHorizontally(R.id.wechat_view_input, ConstraintSet.PARENT_ID)
        moreConstraintSet.constrainHeight(R.id.wechat_view_input, ConstraintSet.WRAP_CONTENT)
        moreConstraintSet.constrainWidth(R.id.wechat_view_input, ConstraintSet.MATCH_CONSTRAINT)

        moreConstraintSet.connect(R.id.wechat_view_more, ConstraintSet.TOP, R.id.wechat_view_input, ConstraintSet.BOTTOM)
    ...
    private fun createResetConstraint() {
        resetConstraintSet.clear(R.id.wechat_view_input)
        resetConstraintSet.clear(R.id.wechat_view_more)

        resetConstraintSet.connect(R.id.wechat_view_input, ConstraintSet.TOP, R.id.wechat_list, ConstraintSet.BOTTOM)
        resetConstraintSet.connect(R.id.wechat_view_input, ConstraintSet.BOTTOM, ConstraintSet.PARENT_ID, ConstraintSet.BOTTOM)
        resetConstraintSet.centerHorizontally(R.id.wechat_view_input, ConstraintSet.PARENT_ID)
        resetConstraintSet.constrainHeight(R.id.wechat_view_input, ConstraintSet.WRAP_CONTENT)
        resetConstraintSet.constrainWidth(R.id.wechat_view_input, ConstraintSet.MATCH_CONSTRAINT)

        resetConstraintSet.connect(R.id.wechat_view_more, ConstraintSet.TOP, R.id.wechat_view_input, ConstraintSet.BOTTOM)
